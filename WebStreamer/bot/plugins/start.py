...
START_TEXT = """
<b>⭐️ Hi {}, Send me any file to get the direct download link</b>"""

HELP_TEXT = """
<b>- Send me any file or media.</b>
<b>- I will provide external download link !</b>
<b>- Add me as admin in your channel for direct download link button !</b>
<b>- This permanent link with fastest speed !</b>\n
"""

ABOUT_TEXT = """
<b>Made by anonymous!</b>"""
    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<b>Sᴏᴍᴇᴛʜɪɴɢ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ</b>",
                    parse_mode=ParseMode.HTML,
                    disable_web_page_preview=True)
                return
        await m.reply_text(
